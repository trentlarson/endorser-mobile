...
export function AppHandyInitializeScreen({navigation}) {
    ...
    <SafeAreaView>
      <ScrollView>
        <View style={{padding: 20}}>
          <Text style={{fontSize: 30, fontWeight: 'bold'}}>Create Keys</Text>
          <View>
                ...
                <View>
                  ...
                  identifiersSelector.map(ident =>
                    <View key={ident.did} style={{ marginTop: 20 }}>
                      ...
                      <Text>Here it is for reference, but you don't have to remember it... we will maintain it for you, and you can find it again any time.</Text>
