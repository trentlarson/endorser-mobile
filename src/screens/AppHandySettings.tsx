...
export function AppHandySettingsScreen({navigation}) {
...
export function AppHandyExportIdentityScreen({navigation}) {
  const [error, setError] = useState<String>('')
  const [hasMnemonic, setHasMnemonic] = useState<boolean>(false)
...
export function AppHandyImportIdentityScreen({navigation}) {
  const [error, setError] = useState<string>('')
