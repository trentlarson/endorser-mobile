...
- ios
  ...
  - Submit the release for review (by filling in the "What's New" and "Notes"), and after they approve the review then you can test in TestFlight or release.
    - Review for TestFlight is different from the app review. Make sure to choose the group for testing, click on the version build numer, and submit for review.
